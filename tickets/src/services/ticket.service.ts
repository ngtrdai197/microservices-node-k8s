...
export class TicketService {
  ...
  public async editTicket(req: Request, resp: Response) {
    ...
    return resp
      .status(201)
      .jsonp({ statusCode: 201, msg: "Edit ticket successfully" });
  }

  public async getTickets(req: Request, resp: Response) {
    return resp
      .status(201)
      .jsonp({ statusCode: 201, msg: "Get tickets successfully" });
  }
  ...
  public async getTicketById(req: Request, resp: Response) {
    ...
    return resp
      .status(201)
      .jsonp({ statusCode: 201, msg: "Get ticket by ID successfully" });
  }
}
